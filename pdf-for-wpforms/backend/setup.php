                ...
                <div class="yeepdf-setup-container">
                    <div class='pdf-for-woocommerce'>
                        <div class="yeepdf-setup-title-text">
                            <?php esc_attr_e("Name Your Template", 'pdf-for-woocommerce'); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch 
                            ?>
                        </div>
                    ...
                    <div class='pdf-for-woocommerce'>
                        <div class="yeepdf-setup-title-text">
                            <?php esc_html_e("Select a Form", 'pdf-for-woocommerce'); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch 
                            ?>
                        </div>
                        <div class="yeepdf-setup-title-input">
                            <?php
