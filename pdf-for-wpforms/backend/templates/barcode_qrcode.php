...
global $yeepdf_settings_qrcode;
class Superaddons_Pdf_Shortcode_Qrcode
{
    function __construct()
    {
        add_filter('yeepdf_builder_block_html', array($this, "barcode_qrcode_builder"), 10);
...
?>
        <li>
            <div class="momongaDraggable pro_disable" data-type="barcode" title="Pro Version">
                ...
                <div class="yeepdf-tool-text"><?php esc_html_e("Barcode", 'pdf-for-woocommerce'); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch 
                                                ?></div>
            </div>
        </li>
        <li>
            <div class="momongaDraggable pro_disable" data-type="qrcode" title="Pro Version">
                ...
                <div class="yeepdf-tool-text"><?php esc_html_e("Qrcode", 'pdf-for-woocommerce'); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch 
                                                ?></div>
            </div>
        </li>
<?php
...
$yeepdf_settings_qrcode = new Superaddons_Pdf_Shortcode_Qrcode;
