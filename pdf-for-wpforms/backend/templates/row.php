...
add_action("yeepdf_builder_tab_block_row","superaddons_pdf_builder_block_row",10);
function superaddons_pdf_builder_block_row(){
    ...
    <li class="builder-row-inner" data-type="row33">
        <span class="bd-row-3"></span>
        <span></span>
    </li>
    <li class="builder-row-inner" data-type="row44">
        <span></span>
        <span class="bd-row-3"></span>
    </li>
    <li class="builder-row-inner " data-type="row5" title=" Pro Version">
        <span></span>
        <span></span>
        <span></span>
    </li>
    <li class="builder-row-inner pro_disable" data-type="row6" title=" Pro Version">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
    </li>
    <li class="builder-row-inner pro_disable" data-type="row7" title=" Pro Version">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
    ...
    <li class="builder-row-inner pro_disable" data-type="row8" title=" Pro Version">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
    ...
    <li class="builder-row-inner pro_disable" data-type="row9" title=" Pro Version">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
...
function superaddons_pdf_builder_block_row_load($type){
    $col = array("row1","row2","row3","row4","row5","row6","row7","row8","row9","row33","row44");
    ...
    $type["block"]["row33"]["builder"]  = '
    <div class="builder-row-container builder__item">
        <div style="background-color: transparent" background_full="not" data-type="row33" class="builder-row-container-row builder-row-container-row33">
            <div class="builder-row bd-row-80">
            </div>
            <div class="builder-row bd-row-20">
            </div>
        </div>
    </div>';
    ...
    $type["block"]["row44"]["builder"]  = '
    <div class="builder-row-container builder__item">
        <div style="background-color: transparent" background_full="not" data-type="row44" class="builder-row-container-row builder-row-container-row44">
            <div class="builder-row builder-row-20">
            </div>
            <div class="builder-row bd-row-80">
            </div>
        </div>
