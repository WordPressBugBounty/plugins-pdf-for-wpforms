...
?>
    <li>
        <div class="momongaDraggable" data-type="text">
            ...
            <div class="yeepdf-tool-text"><?php esc_html_e("Text/HTML", 'pdf-for-woocommerce') //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch 
                                            ?></div>
        </div>
    </li>
<?php
...
function superaddons_pdf_builder_block_text_load($type)
{
    ...
    $type["block"]["text"]["editor"]["inner"]["attr"] = array(
        ".text-content" => array(".builder__editor--html .builder__editor--js" => "html"),
