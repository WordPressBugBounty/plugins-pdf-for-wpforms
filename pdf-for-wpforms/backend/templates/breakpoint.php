...
?>
    <li>
        <div class="momongaDraggable pro_disable" data-type="break" title=" Pro Version">
            ...
            <div class="yeepdf-tool-text"><?php esc_html_e("Page Break", 'pdf-for-woocommerce'); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch 
                                            ?></div>
        </div>
    </li>
<?php
}
add_filter('yeepdf_builder_block_html', "yeepdf_builder_block_break_point_load");
function yeepdf_builder_block_break_point_load($type)
{
