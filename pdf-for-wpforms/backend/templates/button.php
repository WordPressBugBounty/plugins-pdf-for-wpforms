...
?>
    <li>
        <div class="momongaDraggable" data-type="button">
            ...
            <div class="yeepdf-tool-text"><?php esc_html_e("Button", 'pdf-for-woocommerce'); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch  
                                            ?></div>
        </div>
    </li>
<?php
}
add_filter('yeepdf_builder_block_html', "yeepdf_builder_block_button_load");
function yeepdf_builder_block_button_load($type)
{
    ...
    // Data Attr
    $type["block"]["button"]["editor"]["inner"]["attr"] = [".yeepdf_button_a" =>  array(
        ".builder__editor--item-button .button_text" => "text",
