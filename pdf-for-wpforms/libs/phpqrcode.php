...
class QRtools
{
    ...
    public static function markTime($markerId)
    {
        ...
        if (!isset($GLOBALS['qr_time_bench']))
            $GLOBALS['qr_time_bench'] = array(); //phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound

        $GLOBALS['qr_time_bench'][$markerId] = $time; //phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
    }
